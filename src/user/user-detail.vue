...
const mx = [0, 3.394, 10.793, 21.235, 34.322, 49.81, 67.525, 87.337, 109.14, 132.849, 158.39, 185.7, 214.72, 245.41, 277.72, 311.61, 347.05, 384.013, 422.45];
const levelName = ["预备役", "列兵", "上等兵", "下士", "中士", "上士", "少尉", "中尉", "上尉", "大尉", "少校", "中校", "上校", "大校", "少将", "中将", "上将", "大将", "元帅"];
function getPercent() {
            ...
            <Card style="width: 100%;height: 90%;">
                ...
                <center>
                    <div style="font-size: large;">
                        ...
                        <br />
                        您当前经验值为 <span style="color: red;font-weight: 700;">{{ exp.toFixed(2) }}</span>，达成 <span
                            style="color: red;font-weight: 700;">{{ levelName[level] }}</span> 等级。
                    </div>
                </center>
            </Card>
        </div>
