...
export namespace Ace {
    ...
    export interface Command {
        ...
        readOnly?: boolean;
        exec: (editor: Editor, args?: unknown) => void;
    }
    ...
    export interface SyntaxMode {
        ...
        toggleCommentLines(state: unknown,
            session: EditSession,
            startRow: number,
            endRow: number): void;
        toggleBlockComment(state: unknown,
            session: EditSession,
            range: Range,
            cursor: Point): void;
        getNextLineIndent(state: unknown, line: string, tab: string): string;
        checkOutdent(state: unknown, line: string, input: string): boolean;
        autoOutdent(state: unknown, doc: Document, row: number): void;
        // TODO implement WorkerClient types
        createWorker(session: EditSession): unknown;
    ...
    export interface Config {
        ...
        loadModule(moduleName: string | [string, string],
            onLoad?: (module: unknown) => void): void;
        init(packaged: unknown): unknown;
        defineOptions(obj: unknown, path: string, options: { [key: string]: unknown }): Config;
        resetOptions(obj: unknown): void;
        setDefaultValue(path: string, name: string, value: unknown): void;
        setDefaultValues(path: string, optionHash: { [key: string]: unknown }): void;
    }

    export interface OptionsProvider {
        setOptions(optList: { [key: string]: unknown }): void;
        getOptions(optionNames?: string[] | { [key: string]: unknown }): { [key: string]: unknown };
    ...
    export interface KeyBinding {
        ...
        onCommandKey(e: unknown, hashId: number, keyCode: number): boolean;
    ...
    export interface CommandManager extends EventEmitter {
        ...
        exec(command: string, editor: Editor, args: unknown): boolean;
    ...
    export interface Selection extends EventEmitter {
        ...
        setSelectionRange(match: unknown): void;
        getAllRanges(): Range[];
        ...
        selectToPosition(pos: unknown): void;
        selectUp(): void;
        selectDown(): void;
        selectRight(): void;
        selectLeft(): void;
        ...
        moveCursorToPosition(position: unknown): void;
    ...
    export interface Editor extends OptionsProvider, EventEmitter {
        ...
        getCopyText(): string;
        execCommand(command: string | string[], args?: unknown): boolean;
    ...
    type CompleterCallback = (error: unknown, completions: Completion[]) => void;
